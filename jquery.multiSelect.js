...
5px}.multi-select-option label:hover{background:#f1f2f6}.multi-select-option input{float:left;margin:3px 3px 0 0}.multi-select-option span{margin-left:22px;display:block}</style>';
function initCss(){
	if($('#multiSelectCss')[0]){
		return false;
	}
